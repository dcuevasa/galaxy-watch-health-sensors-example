...
public class ConnectionManager {
    ...
    public void initSpO2(SpO2Listener spO2Listener) {
        HealthTracker tracker = healthTrackingService.getHealthTracker(HealthTrackerType.SPO2_ON_DEMAND);
        spO2Listener.setHealthTracker(tracker);
    ...
    public void initHeartRate(HeartRateListener heartRateListener) {
        HealthTracker tracker = healthTrackingService.getHealthTracker(HealthTrackerType.HEART_RATE_CONTINUOUS);
        heartRateListener.setHealthTracker(tracker);
